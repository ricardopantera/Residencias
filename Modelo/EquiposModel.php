<?php
    Class EquiposModel extends Mysql{
        ...
        public function getEquipos(){
            $sql = "SELECT a.id_equipos,a.nombre_equipo, b.nombre_usuario, c.nombre_proyecto FROM asignacion_equipos as a INNER JOIN usuario as b on a.idusuario = b.id_usuario 
        ...
        public function insertEquipo(string $strEquipo,int $strproyecto,int $strjuez){
            $query_insert = "INSERT INTO asignacion_equipos (nombre_equipo,id_proyecto,idusuario) VALUES(?,?,?)";
        ...
        public function getEquipo($id){
            ...
            FROM asignacion_equipos as a INNER JOIN usuario as b on a.idusuario = b.id_usuario 
        ...
        public function UpdateEquipo(string $nombre_equipo,string $idusuario,int $id_proyecto,int $id){
            $query_update = "UPDATE asignacion_equipos SET nombre_equipo = ? ,id_proyecto = ? , idusuario = ?   where id_equipos = '$id'";
            $arrdata = array($nombre_equipo,$idusuario,$id_proyecto);
            $request_update = $this->update($query_update,$arrdata);
            return $request_update;
        }
        public function eliminarequipo($id){
            $sql = "DELETE FROM asignacion_equipos where id_equipos ='$id';";
